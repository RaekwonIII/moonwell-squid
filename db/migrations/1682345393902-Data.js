module.exports = class Data1682345393902 {
    name = 'Data1682345393902'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "account" ("id" character varying NOT NULL, "latest_order" numeric NOT NULL, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`)
    }
