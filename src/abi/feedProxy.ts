...
import {ABI_JSON} from './feedProxy.abi'
...
export const functions = {
    ...
    proposedGetRoundData: new Func<[_roundId: ethers.BigNumber], {_roundId: ethers.BigNumber}, ([roundId: ethers.BigNumber, answer: ethers.BigNumber, startedAt: ethers.BigNumber, updatedAt: ethers.BigNumber, answeredInRound: ethers.BigNumber] & {roundId: ethers.BigNumber, answer: ethers.BigNumber, startedAt: ethers.BigNumber, updatedAt: ethers.BigNumber, answeredInRound: ethers.BigNumber})>(
        abi, '0x6001ac53'
    ),
    proposedLatestRoundData: new Func<[], {}, ([roundId: ethers.BigNumber, answer: ethers.BigNumber, startedAt: ethers.BigNumber, updatedAt: ethers.BigNumber, answeredInRound: ethers.BigNumber] & {roundId: ethers.BigNumber, answer: ethers.BigNumber, startedAt: ethers.BigNumber, updatedAt: ethers.BigNumber, answeredInRound: ethers.BigNumber})>(
        abi, '0x8f6b4d91'
    ),
...
export class Contract extends ContractBase {
    ...
    proposedGetRoundData(_roundId: ethers.BigNumber): Promise<([roundId: ethers.BigNumber, answer: ethers.BigNumber, startedAt: ethers.BigNumber, updatedAt: ethers.BigNumber, answeredInRound: ethers.BigNumber] & {roundId: ethers.BigNumber, answer: ethers.BigNumber, startedAt: ethers.BigNumber, updatedAt: ethers.BigNumber, answeredInRound: ethers.BigNumber})> {
        return this.eth_call(functions.proposedGetRoundData, [_roundId])
    }

    proposedLatestRoundData(): Promise<([roundId: ethers.BigNumber, answer: ethers.BigNumber, startedAt: ethers.BigNumber, updatedAt: ethers.BigNumber, answeredInRound: ethers.BigNumber] & {roundId: ethers.BigNumber, answer: ethers.BigNumber, startedAt: ethers.BigNumber, updatedAt: ethers.BigNumber, answeredInRound: ethers.BigNumber})> {
