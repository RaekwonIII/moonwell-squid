...
import {ABI_JSON} from './mGLMR.abi'
...
export const functions = {
    ...
    _addReserves: new Func<[], {}, ethers.BigNumber>(
        abi, '0xfcb64147'
    ),
    ...
    initialize: new Func<[comptroller_: string, interestRateModel_: string, initialExchangeRateMantissa_: ethers.BigNumber, name_: string, symbol_: string, decimals_: number], {comptroller_: string, interestRateModel_: string, initialExchangeRateMantissa_: ethers.BigNumber, name_: string, symbol_: string, decimals_: number}, []>(
        abi, '0x99d8c1b4'
    ),
    ...
    liquidateBorrow: new Func<[borrower: string, mTokenCollateral: string], {borrower: string, mTokenCollateral: string}, []>(
        abi, '0xaae40a2a'
    ),
    mint: new Func<[], {}, []>(
        abi, '0x1249c58b'
    ...
    repayBorrow: new Func<[], {}, []>(
        abi, '0x4e4d9fea'
    ),
    repayBorrowBehalf: new Func<[borrower: string], {borrower: string}, []>(
        abi, '0xe5974619'
    ),
